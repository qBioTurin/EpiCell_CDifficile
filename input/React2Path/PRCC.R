...
params <- readRDS("./EpitCellDifficileHemeSink_sensitivity/params_EpitCellDifficileHemeSink-sensitivity.RDS")
functions_fname = "Functions.R"
target_value = params$target_value
out_fname = "EpitCellDifficileHemeSink-sensitivity"
out_dir = ""
...
prcc = list(PRCC=PRCC,P.values=P.values)
prcc_frame = prcc$PRCC %>%
  gather(-Time,key = "Param", value = "PRCC") %>%
  na.omit()
ggplot(prcc_frame)+
