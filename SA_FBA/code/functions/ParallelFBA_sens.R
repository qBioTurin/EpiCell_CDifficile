...
ParallelFBA_sens = function(model_file,
  ...
  equation = readRDS(paste0(wd, "/input/equation.rds"))
  officialName = readRDS(paste0(wd, "/input/officialName.rds"))
  geneAssociation = readRDS(paste0(wd, "/input/geneAssociation.rds"))
  
  subsystem = readRDS(paste0(wd, "/input/subsystem.rds"))
  ...
  ParFBA = function(i) {
    ...
    # loading functions
    source(paste0(wd, "/code/functions/class_generation.R"))
    source(paste0(wd, "/code/functions/FBAgreatmodeClass.R"))
    source(paste0(wd, "/code/functions/readMat.R"))
